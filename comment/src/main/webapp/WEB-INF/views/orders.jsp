		...
		<tbody>
			<tr>
				...
				<td class="td-product-block">
					<div class="product-container">
						<div class="product-image">
							...
							<img src="${ListDTO.imagePath}" width="60" height="60" alt="${ListDTO.goodsNm}">
						</div>
				...
				<td class="td-product-quantity">
					<input type="text" name="qty1815265137" id="qty1815265137" readonly="" class="input-quantity" value="${goodsCount}" maxlength="3" title="수량입력란">
				</td>
			
			
				<td class="td-price-condition">
					<p class="set-price">
						<strong><span id="item_prc0"></span></strong><span class="set-price-won">원</span>
					</p>
				...
				<td class="td-order-amount">
					<p class="set-price">
						<strong>
							<span id="item_amt0"></span></strong><span class="set-price-won">원</span>
					</p>
...
<!-- 상품 한칸의 끝 -->
	...
	<div class="order-sum-total">
		...
		<p class="order-sum-price">
			...
			<strong><span id="total_pmt_amt"></span></strong><span class="order-sum-price-won">원</span>
	...
	<table class="tbl_list4 deli_info" summary="주문하시는 분, 영문성명, 주민등록번호, 이메일주소, 배송지 선택, 받으시는분, 배송지주소, 전화번호, 휴대폰번호, 남기실 말씀 항목을 입력할 수 있는 배송정보 입력폼">
		...
		<tbody>
                ...
                <tr class="last">
					...
					<td class="pdb8">
						<div>
							<input type="text" size="10" id="resipient" name="resipient" class="input2" style="width:65px"><br>
						</div>
					</td>
				...
				<tr class="bdrB2">
					...
					<td>
						<div>
						<input type="text" id="noMemEmail1" name="noMemEmail1" value="" maxlength="40" class="input2" style="width:120px"><span id="emailDeli">@</span>
						<input type="text" id="noMemEmail2" name="noMemEmail2" value="" maxlength="20" class="input2" style="width:80px">
						</div>
					</td>
				</tr>
		...
		<tr class="last">
			...
			<td>
				<div>
					<label for="zipCode1_0" class="hide">우편번호 첫번째 3자리</label>
					<input type="text" id="sample4_postcode" placeholder="우편번호" name="zipcode" class="input2" style="width:55px" readonly>
		...
		<tr class="last">
			<td>
            <div id="div_roadNmbaseAddr0">
				<input type="text" id="sample4_roadAddress" placeholder="도로명주소" name="address1" class="input2" style="width:180px" readonly>
				<input type="hidden" id="sample4_jibunAddress" placeholder="지번주소">
				<input type="text" id="sample4_extraAddress" placeholder="상세주소" name="address2" class="input2" style="width:180px" readonly>
				<input type="text" id="sample4_detailAddress" placeholder="참고주소" name="address3" class="input2" style="width:180px">
			</div>
			...
			<td>
				<div>
						<input type="text" id="genrlCltTelno0" title="연락처 첫번째 3자리 입력란" class="input2" style="width:55px" name="genrlTxnoTelno0" maxlength="3" value="">
						- <input type="text" id="genrlTxnoTelno0" title="연락처 두번째 3 ~ 4자리 입력란" class="input2" style="width:55px" name="genrlTxnoTelno0" maxlength="4" value="">
						- <input type="text" id="genrlDtlTelno0" title="연락처 마지막 4자리 입력란" class="input2" style="width:55px" name="genrlDtlTelno0" maxlength="4" value="">
				</div>
			</td>
		</tr>
	</tbody></table>
...
<!-- 결제하기 -->
	...
	<section id="purchase-price-info">
			<article class="purchase-price">
				...
				<main>
					<dl class="amount-information">
						...
						<dd class="information-define"><strong class="apply-amount" id="right_product_amt"></strong>원</dd>
					</dl>
					<dl class="amount-information">
					...
					<dl class="purchase-bill">
						...
						<dd class="price-info">
							...
							<span class="price"><strong id="right_total_ord_amt"></strong>원</span>
						</dd>
					</dl>
				</main>
			</article>
			<article class="purchase-trms" id="jumun">
				<main>
					<button id="btn_order_sheet_payment" class="gui-btn red giant round" type="button" onclick="submitOrder()"><strong>결제하기</strong></button>
				</main>
			</article>
		</section>
</div>
