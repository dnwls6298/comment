					...
					<div class="detailArea ">
						<div class="product-image imgArea keyImg">
							<div class="swiper DetailSwipe">
								<span class="icon">
									<span class="sale_icon">10%</span>
								</span>
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<img src="${pageContext.request.contextPath}/resources/images/detail_img.jpg" />
									</div>
									<div class="swiper-slide">
										<img src="${pageContext.request.contextPath}/resources/images/detail_img.jpg" />
									</div>
						...
						</div><!-- pproduct-image imgArea keyImg -->

						<div class="product-inform">
							<div class="infoArea">
								<div class="prd_title">
									<div class="t1"></div>
									<div class="t2">5088 어골칼슘 폴리감마글루탐산앤 비타민d
										망간 어골칼슘피지에이60정</div>
									<a href="#" class="icon_detail_sns ">
										<img src="/${pageContext.request.contextPath}/resources/images/share.png" alt="sns공유 아이콘">
									</a>
								</div><!-- prd_title  -->
								<div class="priceWrap">
									<div class="discountPriceInfo">
										<div class="title">소비자가</div>
										<div class="listPrice login_need">
											<span>로그인시 볼 수 있습니다.</span>
										</div>
										<div class="listPrice view_price">
											<span>11,500</span><em>원</em>
										</div>
									</div>
									<div class="priceInfo">
										<div class="title">판매자공급가</div>
										<div class="login_need">
											<button>판매자공급가 보기</button><span>VAT포함</span>
										</div>
										<div class="price view_price">
											<span>9,200</span>
											<em>원</em>
											<span class="discountRate">20%</span>
										</div>
									</div>
								...
								<div class="copybtn-wrap">
									<ul>
										<li>
											<div class="title">추천키워드 <button>키워드복사</button></div>
											<p class="con">#문풍지 보급형 틈새막이 스폰지형 5M 1입 외풍 차단
												#문풍지 #문풍지보급형 #틈새막이 #외풍차단 #바람차단</p>
										</li>
										<li>
											<div class="title">스마트스토어 카테고리 <button>카테고리복사</button></div>
											<p class="con">500026699 생활/건강 > 생활용품 > 생활잡화 > 단열시트 </p>
											<p class="caution">*이는 추천하는 카테고리이며, 키워드에 따라 정확하지 않을 수 있습니다.</p>
										</li>
									</ul>
								</div><!-- copybtn-wrap  -->
								<div class="detailimg-down">
									<a href="">
										<strong>상품이미지 다운로드 </strong>
										<span>
											<em>상품이미지 (1개) <button>다운로드</button></em>
											<em>상세이미지 <button>다운로드</button></em>
										</span>
									</a>
								</div><!-- detailimg-down  -->
									...
									<ul>
										<li>
											<div class="purchaseInfoBox cardBenefit">
												...
												<div class="content benefitContent">
													<ul>
														<li>
															<button class="b1">준수</button>
														</li>
													</ul>
												</div>
												<button type="button" class="more more_view1"><span>더보기</span></button>
											</div>
										</li>
										<li>
											<div class="purchaseInfoBox cardBenefit">
												...
												<div class="content benefitContent">
													<ul>
														<li>
															<span class="cards">2010014474 </span>
															<div class="icon">
																<img src="${pageContext.request.contextPath}/resources/images/diamond.png" alt="다이아몬드 아이콘">
															</div>
									...
									<ul>
										<li>
											<div class="purchaseInfoBox">
												<div class="title"><strong>출고속도</strong></div>
												<div class="content benefitContent">
													<ul>
														<li class="savingBenefit">
															<button class="b2">우수</button>
															<div class="textWrap">
																<span></span>
																<strong></strong>
															</div>
										...
										<li>
											<div class="purchaseInfoBox">
												<div class="title"><strong>상품출고율</strong></div>
												<div class="content benefitContent">
													<ul>
														<li class="savingBenefit">
															<button class="b3">일반</button>
															<div class="textWrap">
																<span></span>
																<strong></strong>
															</div>
										...
										<li>
											<div class="purchaseInfoBox">
												<div class="title"><strong>문의응답률</strong></div>
												<div class="content benefitContent">
													<ul>
														<li class="savingBenefit">
															<button class="b4">신규</button>
															<div class="textWrap">
																<span></span>
																<strong></strong>
															</div>
									...
									<div class="priceOptionBox">
										<div class="price">
											<div class="spinnerBox">
												...
												<div class="number">
													<input id="topQuantitySpinner" type="number" min="1" max="3">
													<label for="topQuantitySpinner" class="blind">스피너 값</label>
												</div>
												<button class="plus">+</button>
											</div>
											<span class="won">32,024<em>원</em></span>
										</div>
									</div>
								</div><!-- optionContent  -->
								<div class="btnCart">
								...
								<div class="prd-info-2">
									<div class="prd-info-list">
										<dl>
											<dt>배송 불가 기간</dt>
											<dd class="has-btn">[사유] 기타 연휴 기간 :
												<div class="desc-box">
													<p class="desc">
														2021-08-13 ~ 2021-08-16 출고일정 : 2021-08-17 12:00 PM시 주문 건까지
														당일 출고되며, 이후 주문건은 2021-08-18 부터 순차적으로 출고될 예정이니다.
														<span class="charge">무료</span>
													</p>

												</div>
												<div class="dropdown-wrap">
													<button type="button" class="ico bic-dropdown fn-btn" id="dropdown-btn-2"><span>카드혜택, 안내사항</span></button>
												</div>
											</dd>
											<dt>발주마감시간</dt>
											<dd class="has-btn">10:30 까지 주문완료시 당일 출고
												<div class="desc-box">
													<p class="desc">
														( 단, 사전통보없이 내부사정에 의해 배송소요 기간이
														추가로며칠 더 걸릴경우가 간혹 있으니, 시간이 오래 지났음에도 배송추적이 되지 않을
														경우 1:1문의게시판으로 문의바랍니다.)
														<span class="charge">무료</span>
													</p>
								...
								<li class="swiper-slide line_5">
									<div class="space">
										<div class="PJ_goods_border">
											...
											<div class="txt">
												<a href=""><strong>5088 어골칼슘 폴리감마글루탐산앤비타민d 망간 어골칼슘피지에이60정 할인이벤트 진행중d 망간 어골칼슘피지에이60정 할인이벤트 진행중</strong></a>
											</div>
											<div class="desc">
												<div class="type">
			...
			<div class="item_goods_sec">				
				<div class="detail-contents">
					...
					<ul class="innerContent">
						...
						<li class="">
							<a href="#reviews">상품평
								<strong class="crema-product-reviews-count crema-applied">(0)</strong>
							</a>
						</li>
					</ul>
					</div><!-- item_goods_tab -->
					<div class="detailImg innerContent">
						<p class="detailImg_pc">
							<img src="/${pageContext.request.contextPath}/resources/images/5691.jpg">
						</p><!--  detailImg_pc  -->
					...
					<div id="prdShip" data-anchor-content="">						
						<div class="product-detail__section innerContent">
							...
							<ul class="desc-list detail">
								<li>당사이트는 상품별,주문금액별 배송비정책을 채택하고 있습니다.(주문시 상세페이지에서 배송비를 확인바랍니다.)</li>
								<li>배송은 택배전문회사를 이용배송하며 일부 상품의경우 상점에서 직배송하는 경우도 있습니다. <br>
									1. 상품구입대금 입금확인후 전국 대부분의 지역에서 3~4일내이면 상품을 수령하실 수 있습니다.<br>
									2. (단, 도서산간지역과 일부의 경우는 7~10일 정도 소요 될 수 있습니다.)<br>
									3. 각 배송단계별 진행사항을 메일로 안내드리며, 메일에서 안내드린 송장번호로 현재의 배송진행을 주문배송조회 메뉴에서 직접 확인해 보실 수 있습니다.
								</li>
							</ul>
									...
									<table class="__se_tbl_ext">
										...
										<tbody>
											<tr>
												...
												<td>제품 교환/반품 및 환불은 구입일로 부터 7일이내에 가능하며,상기사항외 배송료는 저희가 부담합니다.[착불로 택배발송해 주시면 됩니다.]
													<p class="noti-text">주식회사 엠에스코리아 의 고객센터 전화 070-4196-0927 및 이메일 [ mskorea3118@naver.com ]으로 연락 주시면 친절히 상담해드립니다.</p>
												</td>
											</tr>
											<tr>
												<th scope="row">교환/반품비</th>
												<td>고객의 단순 변심에 따른 타 상품변경시에는 배송료의 일부를 고객님께서 부담하셔야 하며, 일부상품 특성상 박스및 포장개봉한 제품이나 고객의 부주의로 오염 및 손상된 제품은 반품이 불가능합니다.
													<ul class="desc-list detail">
														<li>또한 상품 신선도관리를 위한 상품은 상품하자를 제외하고는 반품및 교환이 되지 않습니다.</li>
														<li>상품구입시 주의사항을 참조하시기 바랍니다. 신선도관리상품적용 예[토마토,채소류등 농수산물류]</li>
													</ul>
												</td>
											</tr>
											<tr>
												...
												<td>
													주식회사 엠에스코리아 과 재화등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날부터 7일 이내에는 청약의 철회를 할 수 있습니다.
													<p class="noti-text mt20">이용자는 재화등을 배송받은 경우 다음 각호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.</p>
													...
													<p class="noti-text">제2항제2호 내지 제4호의 경우에 주식회사 엠에스코리아 이 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회등이 제한되지 않습니다.</p>

													<p class="noti-text">이용자는 제1항 및 제2항의 규정에 불구하고 재화등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화등을 공급받은 날부터 3월이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.</p>
													<p class="noti-text"></p>
											...
											<tr>
												...
												<td>교환/반품 신청 (임의반품 시, 처리불가)
													<ul class="desc-list detail">
														<li>주식회사 엠에스코리아 은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화등의 대금을 환급합니다. 이 경우 주식회사 엠에스코리아 이 이용자에게 재화등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.</li>
														<li>주식회사 엠에스코리아 은 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐 등의 결제수단으로 재화등의 대금을 지급한 때에는 지체없이 당해 결제수단을 제공한 사업자로 하여금 재화등의 대금의 청구를 정지 또는 취소하도록 요청합니다.</li>
														<li>청약철회등의 경우 공급받은 재화등의 반환에 필요한 비용은 이용자가 부담합니다. 주식회사 엠에스코리아 은 이용자에게 청약철회등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 재화등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회등을 하는 경우 재화등의 반환에 필요한 비용은 주식회사 엠에스코리아 이 부담합니다.</li>
													</ul>
												</td>
											</tr>
										</tbody>
						...
						<div class="ico_inner">
							...
							<div class="view_menu quick_ico_style">
								<div class="quick_ico_img quick_tooltip view_btn" quick-title="최저가미준수신고">
									<a href=""><span class="s3"><img src="/${pageContext.request.contextPath}/resources/images/quick_ico_03.png"></span></a>
								</div>
							</div>
							<div class="view_menu quick_ico_style">
								<div class="quick_ico_img quick_tooltip view_btn" quick-title="필수서식자료">
									<a href=""><span class="s4"><img src="/${pageContext.request.contextPath}/resources/images/quick_ico_04.png"></span></a>
								</div>
							</div>
							<div class="sns_on">
...
<div class="sns_popup" id="sns_popup">
	<div class="popup_title">공유하기<span class="bClose"><img src="/${pageContext.request.contextPath}/resources/images/quick_ico_open_02.png" alt="sns공유 팝업 닫기 아이콘"></span></div>
	<div class="social">
		<span><img src="/${pageContext.request.contextPath}/resources/images/sns_popup_face.gif" onclick="" alt="">페이스북</span>
		<span><img src="/${pageContext.request.contextPath}/resources/images/sns_popup_tw.gif" onclick="" alt="">트위터</span>
		<span class=""><a href=""><img src="/${pageContext.request.contextPath}/resources/images/sns_popup_ka.png"></a>카카오톡</span>
		<span><a href="#none" class="copytoclipboard"><img src="/${pageContext.request.contextPath}/resources/images/sns_popup_url.png" alt="URL복사 아이콘">URL 복사</a>
		<input id="url_text" type="text"></span>
	</div>
</div><!--sns_popup-->
<div class="bgbk"></div>
</div><!--sns_popupwrap-->
	...
	<div class="popup-page-body">
		...
		<div class="popup-local">
			...
			<div class="popup-local-head">
				<div class="popup-local-title"><h2 class="popup-local-name">상품타입</h2></div>
			</div><!--//popup-local-head-->
			<!--popup-local-body-->
						...
						<div class="data-display">
							<ul class="data-list">
								<li class="data-item">
									...
									<ul class="con">
										<li>가격자율<span class="s1">자율</span> : 마켓 등에서 자유롭게 판매가를 책정하여 판매할 수 있습니다.</li>
										<li>가격준수<span class="s2">준수</span> : 마켓 등에서 일정한 가격이 형성되어 있는 상품으로, 명성코리아에서 노출되고 있는 소비자가 이상으로 판매하여야 합니다.</li>
										<li></li>
									</ul>							
								</li>
								<li class="data-item">
									...
									<ul class="con">
										<li>무료배송<span class="s3">무료</span> : 무료배송 상품입니다.</li>
										<li>해외배송<span class="s4">해외</span> : 해외에서 구매자에게 배송되는 상품입니다.</li>
										<li></li>
									</ul>							
								</li>													
							</ul>
			...
			</div><!--popup-local-body-->
			<!--//popup-body-->
		<button type="button" class="btn popup-close"><img src="/${pageContext.request.contextPath}/resources/images/quick_ico_open_02.png"></button></div>
		<!--//popup-local-->
	</div>
</div>	
